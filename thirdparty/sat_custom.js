...
(function (root, factory) {
   ...
   * @return {Polygon} This for chaining.
   */
  Polygon.prototype['setPreOffset'] = Polygon.prototype.setPreOffset = function(preoffset) {
  ...
  Polygon.prototype._recalc = function() {
    ...
    var preoffset = this['preoffset'];
    var angle = this['angle'];
    var len = points.length;
    var i;
    for (i = 0; i < len; i++) {
      var calcPoint = calcPoints[i].copy(points[i]);
      calcPoint.x += preoffset.x;
      calcPoint.y += preoffset.y;
      if (angle !== 0) {
